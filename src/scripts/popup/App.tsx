...
class AppInner extends Component<IAppProps> {
  constructor(props) {
    super(props);
  ...
  public componentDidUpdate(previousProps: Readonly<IAppProps>) {
    if (
      this.props.user.company_id !== previousProps.user.company_id &&
  ...
  private renderContent() {
    ...
    return <LoginForm onLogin={this.onLogin} errorMessage={this.props.user.loginError} />;
  }
...
export const App = connect((s) => s)(AppInner as any);
